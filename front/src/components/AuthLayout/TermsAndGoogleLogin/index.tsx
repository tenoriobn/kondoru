  ...
  return (
    <div className="grid gap-8">
      <p className="text-base font-light text-gray-300/60 text-center md:text-xl">
        ...
        <span className="underline font-bold cursor-pointer transition duration-300 ease-in-out hover:text-white-80 active:text-white">
          Termos de uso
        </span>{' '}
        e{' '}
        <span className="underline font-bold cursor-pointer transition duration-300 ease-in-out hover:text-white-80 active:text-white">
        ...
        <Link
          href="/"
          className="underline font-bold cursor-pointer transition duration-300 ease-in-out hover:text-white-80 active:text-white"
        >
          Kondoru
        </Link>
